...
module.exports = (sourceFilePath, destFilePath) => {
  assert(path.isAbsolute(sourceFilePath), `Source must be absolute. Was: ${sourceFilePath}`)
  assert(path.isAbsolute(destFilePath), `Dest must be absolute. Was: ${destFilePath}`)
